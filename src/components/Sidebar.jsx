  ...
  <div className="mt-10">
    {links.map(item => (
      <NavLink
        ...
        text-sm font-medium text-gray-200 hover:text-green-400"
  ...
  return (
    <>
      ...
      <div className="md:flex hidden flex-col w-[240px] py-10 px-4 bg-[#000000]">
        <img src={logo2} alt="logo" className="w-full h-20 object-contain" />
        <NavLinks />
      </div>
      ...
      {/* Mobile menu */}
      <div className={`absolute top-0 h-screen w-2/3 bg-gradient-to-tl from-white/4
      to-[#25b267] backdrop-blur-lg z-10 p-6 md:hidden smooth-transition 
